...
const ALIVE = process.env.ALIVE || "*🌸 Kon'nichiwa , I am alive now*";
const HANDLERS = process.env.HANDLER || ".";
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:9b47db4b5d469532755e4a2f65a85874";
const SUDO = process.env.SUDO || '94773789258';
...
const BOT_INFO = process.env.BOT_INFO || "Interworld;Itzmecp;https://i.ibb.co/5kmL7y2/file-2072.jpg";
const URL = process.env.URL || "https://t.me/itzmecp";
